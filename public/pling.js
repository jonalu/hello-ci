...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxReducer = __webpack_require__(180);
	...
	var store = _redux.applyMiddleware.apply(undefined, middleware)(_redux.createStore)(_reduxReducer2.default, window.__dehydratedState);
...
/***/ function(module, exports) {
	...
	function reducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? { tournaments: [] } : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {
	    case 'RECEIVE_TOURNAMENTS':
	      return _extends({}, state, { tournaments: action.tournaments });
	    default:
	      return state;
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Tournament = __webpack_require__(182);

	var _Tournament2 = _interopRequireDefault(_Tournament);

	var _reduxActions = __webpack_require__(185);
	  ...
	  _createClass(Schedule, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      socket.on('matches', function (tournaments) {
	        return _this2.props.dispatch((0, _reduxActions.updateTournaments)(tournaments));
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.props.tournaments.map(function (t) {
	            return _react2.default.createElement(_Tournament2.default, _extends({ key: t.id }, t));
	          })
	        )
	      );
	    }
	...
	Schedule.propTypes = {
	  tournaments: _react2.default.PropTypes.array
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Match = __webpack_require__(183);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.props.matches.map(function (m) {
	            return _react2.default.createElement(_Match2.default, _extends({ key: m.id }, m));
	          })
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.props.teamA.name
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'team-goals' },
	          this.props.teamA.goals
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'play-time font-small' },
	          playTime
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'team-goals' },
	          this.props.teamB.goals
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'team-name team-away' },
	          this.props.teamB.name
	        )
	      );
	    }
	  }]);
	...
	Match.propTypes = {
	  teamA: _react2.default.PropTypes.object,
	  teamB: _react2.default.PropTypes.object,
	  matchStatus: _react2.default.PropTypes.object,
	  startTime: _react2.default.PropTypes.string,
	  playTime: _react2.default.PropTypes.string
	};
...
/***/ function(module, exports) {
	...
	exports.updateTournaments = updateTournaments;
	...
	exports.default = { updateTournaments: updateTournaments };
